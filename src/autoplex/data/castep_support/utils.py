...
class CastepInputSet:
    ...
    user_param_settings: dict = field(default_factory=dict)  # equivalent to user_incar_settings
...
class CastepStaticMaker(BaseCastepMaker):
    ...
    **kwargs
    ...
    name: str = "static"
    input_set_generator: CastepInputGenerator = field(default_factory=CastepStaticSetGenerator)
