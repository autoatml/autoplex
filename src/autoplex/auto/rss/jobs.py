...
def initial_rss(
    ...
    **fit_kwargs,
    ...
    do_dft_static = DFTStaticLabelling(
        ...
        static_energy_maker_isolated_species=loadfn(
            static_energy_maker_isolated_species
        ),
        static_energy_maker_isolated_species_spin_polarization=loadfn(
    ...
    **fit_kwargs,
    ...
    if (
        ...
        do_dft_static = DFTStaticLabelling(
            ...
            static_energy_maker_isolated_species_spin_polarization=loadf(
                static_energy_maker_isolated_species_spin_polarization
            ),
