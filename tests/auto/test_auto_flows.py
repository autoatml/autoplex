...
def ref_paths5_mpid():
    return {
        ...
        "dft phonon static_test": "MP_finetuning/static_test/",
        "dft phonon static 1/1_test": "MP_finetuning/phonon_static_1/",
        "dft phonon static 1/3_test": "MP_finetuning/rand_static_1/",
        "dft phonon static 2/3_test": "MP_finetuning/rand_static_2/",
        "dft phonon static 3/3_test": "MP_finetuning/rand_static_3/",
    }
...
# def test_complete_dft_vs_ml_benchmark_workflow_mace_finetuning_MP_settings_little_data(
#         vasp_test_dir, mock_vasp, test_dir, memory_jobstore, ref_paths5_mpid, fake_run_vasp_kwargs5_mpid, clean_dir
# ):
#     from jobflow import run_locally
#
