...
The section allows you to set up static calculations based on DFT or force fields for accurately labelling training structures, including bulk, isolated atoms, and dimers. This can be specified in the RSS config file as:
